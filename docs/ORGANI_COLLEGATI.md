...
| **kernel** (matematica) | oracolo numerico; giudica il claim, non lo inventa | `CASCADE_MATEMATICA_KERNEL` | no |
...
Senza PRISM, kernel o LBP, CASCADE continua a fare il suo mestiere: **bloccare, firmare, registrare**. I test che richiedono quei backend sono `skip` se il path manca.
